...
crearUsuario = async (req,res) => {
    try{
        const {nombre,apellido,email,contrasenia,esPaciente,especialidad, horarioInicioAtencion,horarioFinalAtencion} = req.body;
...
editarUsuario =  async (req, res) => {
  try{
    ...
    res.status(500).send('Error en el servidor - Usuario no actualizado ' + error)
  }
}
...
module.exports = { crearUsuario , login , editarUsuario , obtenerUsuario , obtenerUsuarios , obtenerMedicos , obtenerPacientes};
